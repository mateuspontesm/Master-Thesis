...
\departamento{Departamento de Teleinformática}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%        Informacao para TCC de Graduacao         %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\graduacaoem{Engenharia Xxx}
...
\programamestrado{Programa de Pós-Graduação em Engenharia de Teleinformática}
\nomedomestrado{Mestrado Acadêmico em Engenharia de Teleinformática}
\mestreem{Engenharia de Teleinformática}
\areadeconcentracaomestrado{Engenharia de Teleinformática}
...
\titulo{Link Adaptation Solutions based on Reinforcement Learning}
\data{2019}
\local{Fortaleza}
...
\orientador{Prof. Dr. André Lima Ferrer de Almeida}
...
\coorientador{Prof. Dr. Francisco Rodrigo Porto Cavalcanti}
