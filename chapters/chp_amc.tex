...
%
The parameters \azm~$\in$ \range{0}{2\pi} and \elev~$\in$ \range{0}{\pi} denote the azimuth and elevation angles at the \bs \, (\gls{aod}) and the \ue \, (\gls{aoa}).
%
...
% State                   & \gls{cqi} \\
% Action                  & \gls{mcs} \\
% Reward                  & Eq: \eqref{eq.:reward1}, \eqref{eq.:rewardBler}, \eqref{eq.:rewardSE} \\
% \bottomrule
% \end{tabularx}
% \end{table}
% %
...
%   The BS \emph{takes an action} $a: MCS$ using the policy driven by $Q$ (e.g., $\epsilon$-greedy);\\
...
% %
% The Table \ref{tab:train-results} summarizes the results, providing average values, of the metrics for each configuration of the \gls{ql-amc}.
% %
...
% \end{table}
%
% Table \ref{tab:train-results} reveals that configurations adopting the spectral efficiency (reward 2) as the reward function, with state space of lengths 10 or 60, achieve the best results in terms of spectral efficiency.
% %
...
% %
% Figures \ref{fig:train-spceff} and \ref{fig:train-bler} shows respectively the average spectral efficiency and the average \gls{bler} of these four possible configurations.
% %
% Figure \ref{fig:train-spceff} shows that the length of the state space indeed has an important influence on the learning speed.
% %
...
%
% \begin{figure}[!htbp]
% \centerline{\includegraphics[width=\columnwidth]{figs/Spec-Eff-Train.pdf}}
% \caption{Mean spectral efficiency on training phase}
% \label{fig:train-spceff}
% \end{figure}
%
% \begin{figure}[!htbp]
% \centerline{\includegraphics[width=\columnwidth]{figs/BLER-Train.pdf}}
% \caption{Mean \gls{bler} on training phase}
% \label{fig:train-bler}
% \end{figure}
%
% The performances of the \gls{ql-amc}s in terms of \gls{bler} are similar for all configurations in Figure \ref{fig:train-bler}.
% %
