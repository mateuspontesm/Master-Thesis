...
\label{tab:mcs-table}
\begin{tabularx}{0.8\columnwidth}{l X X r}
  \toprule
...
The \gls{crc} bits are calculated from a cyclic generator polynomial. In the \gls{pdsch} procedure there are three polynomials that can be used \cite{3gpp.38.212}:
