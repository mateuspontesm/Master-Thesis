...
%
Another aspect in \gls{la} is the rank adaptation, which defines the appropriate number of transmitted spatial streams to be selected before transmission.
%
...
Considering the what has been presented in the previous subsection, the main objectives of this work are:
\begin{enumerate}
...
On one hand, Chapter \ref{chp:amc} introduces the \gls{amc} problem, our proposed solution and compares it against standard \gls{amc} solutions, the \gls{illa} and \gls{olla}.
%
...
The content of this thesis, more specifically Chapter \ref{chp:amc}, has been partially published and presented at 2019 IEEE Globecom Workshops.
%
